...
Additionally, using Qwen2.5-72B as a judge to evaluate Qwen2.5-7B outputs may introduce same-family bias, as models from the same family may share similar tokenization patterns and training data preferences~\cite{zheng2024judging}. Cross-family evaluation using judges from different model families (e.g., LLaMA or Mistral) would provide a more robust assessment and is recommended for future work. Furthermore, while LLM-as-Judge has been validated as a reliable evaluation proxy~\cite{zheng2024judging}, a user study with actual programming students would provide additional validation of the system's educational effectiveness.
